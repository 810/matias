...
<div class="modal hide fade" id="kreply<?php echo $message->displayField('id') ?>_form" class="kreply-form" data-backdrop="false" style="position: relative; top: 10px; left: 0; right: -10px; width:auto; margin:0; z-index: 1; border-color:#e5e5e5;">
